...
const CustomerWiseItem = () => {
    ...
    const fetchItems = async (custid) => {
        console.log("Fecsdsd");
        try {
            const response = await fetch(`https://gnj.onrender.com/api/auth/customerWiseItem/${custid}`);
            if (!response.ok) {
  ...
  //     setLoading(true);
  //     try {
  //         const response = await fetch(`https://gnj.onrender.com/api/auth/items/${customerItems._id}`, {
  //             method: "PUT",
  //             headers: {
  //                 "Content-Type": "application/json",
  //             },
  ...
  // };
    ...
    const handleVendorChange = (selectedOption) => {
        ...
        // updateItemVendor(selectedOption.value);
    };
...
{console.log(customerItems, "user Data")}
...
export default CustomerWiseItem;
